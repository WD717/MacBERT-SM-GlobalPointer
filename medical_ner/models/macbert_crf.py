...
from .base_model import BertBaseModel
from TorchCRF import CRF
from config import config


class MacBertCRF(nn.Module):
    """MacBERT-CRF模型"""
    ...
    def __init__(self, num_tags, model_path=None):
        ...
        super().__init__()
        # MacBERT基础模型
        self.bert = BertBaseModel(model_path=model_path, model_type='macbert')
        
        # 线性层，将MacBERT输出映射到标签空间
        self.classifier = nn.Linear(self.bert.hidden_dim, num_tags)
    ...
    def forward(self, input_ids, attention_mask=None, token_type_ids=None, labels=None):
        ...
        # 映射到标签空间
        emissions = self.classifier(bert_out)
